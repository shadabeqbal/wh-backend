                ...
                <tr>
                    <td bgcolor='#ffffff' style='padding: 40px 30px 40px 30px;'>
                        <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                            ...
                            <tr>
                                <td style='color: #153643; font-family: Sans-serif, sans-serif; font-size: 14px; line-height: 20px;'>
                                    <p>Please verify your email address by clicking the link below.</p><br><br>
                                    <p style='text-align:center;'><i><strong>Healthy mind _ Fulfilling lives</strong></i></p>
                                </td>
                            </tr>
